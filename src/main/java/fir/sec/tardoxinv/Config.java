...
public class Config
{
    ...
    /**
     * Validate if the given string represents a valid item ResourceLocation (namespace:path).
     */
    private static boolean validateItemName(final Object obj)
    {
        ...
        // 최신 Forge 권장 방식: fromNamespaceAndPath 사용
        ResourceLocation loc = ResourceLocation.fromNamespaceAndPath(parts[0], parts[1]);
        return ForgeRegistries.ITEMS.containsKey(loc);
    }

    /**
     * Called when config is loaded or reloaded. Converts item strings to actual Item instances.
     */
    @SubscribeEvent
    static void onLoad(final ModConfigEvent event)
    {
        ...
        // Convert string list to Item set
